...
$DATABASE_USER = 'epiz_27081301';
$DATABASE_PASS = 'oGM667NEMc';
$DATABASE_NAME = 'epiz_27081301_pollapp_ml';
try {
        ...
        if ($comment['parent_id'] == $parent_id) {
            ...
            <div class="comment">
                <div style="margin: 0 !important">
                    <h3 class="name" style="margin: 0 !important"><b>' . htmlspecialchars($comment['name'], ENT_QUOTES) . '</b></h3>
                    <span class="date right" style="margin: 0 !important">' . time_elapsed_string($comment['submit_date']) . '</span>
                </div>
                <p class="content" style="margin: 0 !important;line-height: 1.5 !important">' . nl2br(htmlspecialchars($comment['content'], ENT_QUOTES)) . '</p>
...
function show_write_comment_form($parent_id = -1) {
    ...
    <div class="write_comment" data-comment-id="' . $parent_id . '">
        <form>
            ...
            <button type="submit" class="btn blue-grey">Send</button>
        </form>
    </div>
    ';
    return $html;
...
?>
<br><hr><br>
    <a href="#" class="write_comment_btn btn blue-grey darken-3 right" data-comment-id="-1">Compose</a>
<h5>Comments (<span class="total"><?=$comments_info['total_comments']?></span>)</h5>
...
<?php 
if($comments_info['total_comments'] == 0) {
?>
<center><img src="https://cdn.dribbble.com/users/1121009/screenshots/11030107/media/25be2b86a12dbfd8da02db4cfcbfe50a.jpg?compress=1&resize=500x400" style="max-width: 100%"><br><b>No comments!</b></center>
<br><br>
<?php
}
?>